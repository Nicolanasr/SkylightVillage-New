                        ...
                        <ul className="space-y-5 text-xs text-gray-700">
                            <li className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="https://maps.app.goo.gl/v3TU1HqX9YGE1hSSA" target="_blank" rel="noopener noreferrer" className="hover:text-skylight-gold transition-colors font-medium">
                                        Jaj, Mount Lebanon, Lebanon (Open in Maps ↗)
                                    </a>
                                </div>
                            </li>
                            <li className="flex gap-3">
                                ...
                                <div>
                                    <span className="font-semibold text-skylight-green block">Mobile &amp; WhatsApp Hotline</span>
                                    <a href="https://wa.me/96170663399" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-700 transition-colors font-semibold">
                                    +961 70 663399 (Tap to Chat on WhatsApp)
                                </a>
                            </div>
                        </li>
                        <li className="flex gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@skylightvillagelb.com" className="hover:text-skylight-gold transition-colors">info@skylightvillagelb.com</a>
                            </div>
                        </li>
                    </ul>
                ...
                <div className="lg:col-span-2 bg-white rounded-3xl border border-skylight-green/10 shadow-xl p-8 relative overflow-hidden">
                    ...
                    {submitted ? (
                        <div className="text-center py-12 space-y-5">
                            ...
                            <p className="text-xs text-gray-500 font-light max-w-sm mx-auto leading-relaxed">70 66 33 99
                                Thank you, <span className="font-bold text-skylight-green">{formData.name}</span>. Your message has been logged. You can also chat directly with our concierge desk on WhatsApp (+961 70 663399).
                            </p>
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                                <a
                                    href={`https://wa.me/96170663399?text=${encodeURIComponent(
                                        `Hello Skylight Village!\n\nName: ${formData.name}\nPhone: ${formData.phone}\nSubject: ${formData.subject}\nMessage: ${formData.message}`
                                    )}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="px-6 py-3 bg-[#25D366] hover:bg-[#20ba5a] text-white font-display font-extrabold text-xs uppercase tracking-widest rounded-xl transition-all shadow-lg inline-flex items-center gap-2"
                                >
