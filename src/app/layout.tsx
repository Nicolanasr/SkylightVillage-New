...
export const metadata: Metadata = {
    ...
    title: {
        default: "Skylight Village Jaj | Camping Ground, Cabins & Picnic",
        template: "%s | Skylight Village Jaj",
    },
    description:
        "Campsite, wooden cabins, scout group grounds & day picnic area in Jaj, Mount Lebanon at 1,200m altitude near Jaj Cedar Reserve. تخييم وبنيكنيك في جبيل",
    keywords: [
    ...
    openGraph: {
        title: "Skylight Village Jaj | Camping Ground, Cabins & Picnic",
        description:
            "Campsite, wooden cabins, scout group grounds & day picnic area in Jaj, Mount Lebanon at 1,200m altitude near Jaj Cedar Reserve.",
        url: siteUrl,
    ...
    twitter: {
        ...
        title: "Skylight Village Jaj | Camping Ground in Jbeil, Lebanon",
        description:
